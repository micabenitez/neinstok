export default function Portfolio() {
    return (
        <section id="portfolio" className="relative bg-white h-[40rem] text-black">
            <div className="h-[49rem] w-[36rem] bg-[#f4f4f4] absolute -top-12 left-[7rem] p-16 flex flex-col justify-around">
